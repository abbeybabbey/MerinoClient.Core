...
namespace MerinoClient.Core.VRChat
{
    public static class PopupManagerExtensions
    {
        ...
        public static void ShowColorInputPopup(this VRCUiPopupManager popupManager, MenuButton button, string who, ConfigValue<Color> configValue)
        {
        ...
        public static void ShowInputPopup<T>(this VRCUiPopupManager popupManager, string popupText, T oldValue, Action<T> callback, MenuButton menuButton = null, string buttonText = null, ValueRange<T> range = null) where T : IComparable
        {
        ...
        public static void ShowInputPopup<T>(this VRCUiPopupManager popupManager, string popupText, ConfigValue<T> configValue, MenuButton menuButton = null, string buttonText = null, ValueRange<T> range = null) where T : IComparable
        {
            popupManager.ShowInputPopupWithCancel($"{popupText} {(range!=null ? $"Range: {range.MinValue}-{range.MaxValue}" : string.Empty)}",
