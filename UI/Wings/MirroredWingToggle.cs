...
{
    public class MirroredWingToggle
    {
        private readonly WingToggle _leftToggle;
        private readonly WingToggle _rightToggle;
        ...
        public MirroredWingToggle(string text, string tooltip, Action<bool> onToggle, Transform leftParent,
            Transform rightParent, bool defaultValue = false)
        {
            _leftToggle = new WingToggle(text, tooltip, b =>
            {
                _rightToggle?.Toggle(b, false);
                onToggle(b);
            }, leftParent, defaultValue);
            _rightToggle = new WingToggle(text, tooltip, b =>
            {
