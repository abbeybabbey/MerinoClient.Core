...
namespace MerinoClient.Core.UI.Wings
{
    public class WingButton : UiElement
    {
        ...
        public WingButton(string text, string tooltip, Action onClick, Sprite sprite = null, bool left = true,
        ...
        public WingButton(string text, string tooltip, Action onClick, Transform parent, Sprite sprite = null, bool arrow = true, bool background = true,
            ...
            WingSide wingSide = WingSide.Both, bool arrow = true, bool background = true, bool separator = true)
        {
            ...
            {
               new WingButton(text, tooltip, onClick, sprite, true, arrow, background, separator);
            }

            if ((wingSide & WingSide.Right) == WingSide.Right)
            {
                new WingButton(text, tooltip, onClick, sprite, false, arrow, background, separator);
            }
        }
        ...
        {
            new WingButton(text, tooltip, onClick, parent, sprite, arrow, background, separator);
        }
    }
}