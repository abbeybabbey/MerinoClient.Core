...
namespace MerinoClient.Core.UI
{
    public class UiButton : UiElement
    {
        ...
        public UiButton(string text, Vector2 pos, Vector2 scale, Action onClick, Transform parent = null) : base(
            GameObject.Find("UserInterface/MenuContent/Screens/UserInfo/ViewUserOnVRChatWebsiteButton"), parent, pos,
            $"{text}UiButton")
        {
