...
{
    public class RadioTogglePage : UiElement
    {
        ...
        public void Open(Object selected = null)
        {
            ...
            if (_isUpdated)
            {
                ...
                {
                    var toggle = new RadioToggle(_toggleGroupRoot.transform, newElement.Item1, newElement.Item1, newElement.Item2);
        ...
        private void OnToggleSelect(RadioToggle toggle, bool state)
        {
            foreach (var element in _radioElements)
            {
                if(element == toggle)
