...
namespace MerinoClient.Core.UI.QuickMenu
{
    public class MenuButton : UiElement
    {
        ...
        public MenuButton(string text, string tooltip, Action onClick, Transform parent, Sprite sprite = null, bool resizeTextNoSprite = true) : base(ButtonPrefab, parent,
            $"Button_{text}")
        {
        ...
        public MenuButton(Transform transform) : base(transform)
        {
            _text = GameObject.GetComponentInChildren<TextMeshProUGUI>();
            _styleElement = GameObject.GetComponent<StyleElement>();
            _button = GameObject.GetComponent<Button>();
        ...
        public static MenuButton Create(string text, string tooltip, Action onClick, Transform parent, Sprite sprite = null)
        {
            return new MenuButton(text, tooltip, onClick, parent, sprite);
        }
    }
}
